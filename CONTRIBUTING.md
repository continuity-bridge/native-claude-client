# Contributing to ntive-claude-client
...
1. **Share your workflow** in [Discussions](https://github.com/continuity-bridge/ntive-claude-client/discussions)
...
The best way to shape the project is through [Discussions](https://github.com/continuity-bridge/ntive-claude-client/discussions).

**Active topics:**
- [Window Layout: Tabs vs Panes vs Hybrid?](https://github.com/continuity-bridge/ntive-claude-client/discussions/1)
- [What features would make this useful for your workflow?](https://github.com/continuity-bridge/ntive-claude-client/discussions/2)
...
See [Wiki: Development Setup](https://github.com/continuity-bridge/ntive-claude-client/wiki/Development-Setup) for environment configuration (coming soon).
...
def load_session(session_id: str) -> dict:
    ...
    session_file = Path.home() / '.config' / 'ntive-claude-client' / f'{session_id}.json'
...
- **General questions:** [Q&A Discussions](https://github.com/continuity-bridge/ntive-claude-client/discussions/categories/q-a)
- **Design questions:** [Design Decisions](https://github.com/continuity-bridge/ntive-claude-client/discussions/categories/design-decisions)
- **Bugs (post-v0.1):** [Issues](https://github.com/continuity-bridge/ntive-claude-client/issues)
